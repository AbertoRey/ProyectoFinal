  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
		...
		<li class="pull-right"> <a style="background-color:rgb(253, 0, 1); color:white; " href="logout.php?q=account.php"><span  class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;Desconectar</a></li>
		</ul>
            <form class="navbar-form navbar-left" role="search">
        <div class="form-group">
          <input type="text" class="form-control" placeholder="Ingrese tag ">
        </div>
...
$h=mysqli_query($con,"SELECT * FROM quiz WHERE eid='$eid'" );
echo '<div class="panel" style="margin:5%">';
$row2=mysqli_fetch_array($h);
$wh=$row2['intro'];
echo '<b>Intro &nbsp;'.$wh.'</b><br /><br/>';
...
<tr style="color:black"><td><b>S.N.</b></td><td><b>Quiz</b></td><td><b>Preguntas resueltas</b></td><td><b>Buenas</b></td><td><b>Malas<b></td><td><b>Puntaje</b></td>';
$c=0;
while($row=mysqli_fetch_array($q) )
{
$eid=$row['eid'];
...
<table class="table table-striped title1" >
<tr style="color:black"><td><b>Puesto</b></td><td><b>Nombre</b></td><td><b>Genero</b></td><td><b>Carrera</b></td><td><b>Puntaje</b></td></tr>';
$c=0;
while($row=mysqli_fetch_array($q) )
{
$e=$row['email'];
